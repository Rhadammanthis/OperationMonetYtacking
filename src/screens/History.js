          ...
          <TouchableHighlight
            ...
            <View
              ...
              <Text style={{fontSize: 20, color: 'black'}}>
                {applyMoneyMask(item.amount)} {this.currency}
              </Text>
              <View style={{flex: 1}} />
          ...
          <Animated.View
            ...
            <TouchableHighlight
              onPress={evt => {
                ...
                this.props.navigation.state.params.onUpdated(
                  this.category,
                  this.amount,
                );
              }}>
    ...
    return (
      <View
        style={{
          ...
          backgroundColor: getColor(this.category),
        }}>
        <View
          style={{
            flexDirection: 'column',
          ...
          <Animated.View
            style={[styles.icon, {backgroundColor: getColor(this.category)}]}>
        ...
        <View
          ...
          <View style={{flexDirection: 'row', margin: 10}}>
            <LocalizedText
              localizationKey={'history_amount'}
              style={{fontSize: 25, color: 'black'}}
            />
            <View style={{flex: 1}} />
            <LocalizedText
              localizationKey={'history_time'}
              style={{fontSize: 25}}
            />
          </View>
          {this._renderHistory()}
