...
class SignUpModal extends Component {
  constructor(props) {
    ...
    this.state = {
      email: '',
      password: '',
      animError: new Animated.Value(0),
    ...
    setTimeout(() => {
      firebase
        ...
        .catch(reason => {
          ...
          setTimeout(() => {
            this.animateErrorMessage(reason.code);
          }, 200);
        })
  ...
  render() {
    ...
    return (
      <View
        ...
        <LocalizedText
          localizationKey={
            accountCreated ? 'account_title_done' : 'account_title'
          }
          style={styles.title}
        />
          ...
          {accountCreated ? (
            <View style={{flex: 3}}>
              ...
              <TouchableOpacity
                ...
                <View style={styles.button}>
                  <LocalizedText
                    localizationKey={'account_button_log_in'}
                    style={{color: 'white'}}
                  />
                </View>
              </TouchableOpacity>
            ...
            <View style={{flex: 3}}>
              ...
              <TextInput
                ...
                placeholder={translate('account_email_hint')}
              />
              <LocalizedText
                localizationKey={'account_password'}
              ...
              <TextInput
                ...
                placeholder={translate('account_password_hint')}
              />
              <LocalizedText
                localizationKey={'account_repeat_password'}
                style={{color: 'white', marginTop: 10}}
              />
              <TextInput
                editable={editable}
              ...
              <TouchableOpacity
                ...
                <View style={styles.signUpButton}>
                  <LocalizedText
                    localizationKey={'account_button_sign_up'}
                    style={{color: 'white'}}
                  />
                </View>
              </TouchableOpacity>
            ...
            transform: [
              {
                translateY: spinner.interpolate({
                  inputRange: [0, 1],
                  outputRange: [HEIGHT + 150, HEIGHT * -0.1],
                }),
              },
            ],
          }}>
